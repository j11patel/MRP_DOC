...
for(i in 1:nrow(test1)){
  test1$AMPK_MEDIAN[i] <- median(c(test1$FC.MYC[i],test1$FC.MYCN[i],test1$FC.MYCL1[i]))  
}
...
ggsurvplot ( sfit,
             ...
             title = "(OVERALL) (MYC, MYCN, MYCL1 MEDIAN) vs RB1 FOLD CHANGE")
...
ggsurvplot ( sfit,
             ...
             legend.labs = c("High diiference   ", "Low difference   "),     # change legend labels.
             palette = c("#E7B800", "#2E9FDF"),
             title = "(TRIPLE NEGATIVE) - (MYC, MYCN, MYCL1 MEDIAN) vs RB1 FOLD CHANGE")              # Main Title
...
ggsurvplot ( sfit,
             ...
             legend.labs = c("High diiference   ", "Low Difference   "),     # change legend labels.
             palette = c("#E7B800", "#2E9FDF"),
             title = "(LUMINAL) - (MYC, MYCN, MYCL1 MEDIAN) vs RB1 FOLD CHANGE")              # Main Title
