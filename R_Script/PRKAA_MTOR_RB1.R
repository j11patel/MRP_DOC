...
for(i in 1:nrow(test1)){
  test1$AMPK_MEDIAN[i] <- median(c(test1$FC.PRKAA1[i],test1$FC.PRKAB1[i],test1$FC.PRKAB2[i],test1$FC.MTOR[i]))  
}
...
ggsurvplot ( sfit,
             ...
             title = "(OVERALL) (PRKAA1, PRKAB1, PRKAB2, MTOR MEDIAN) vs RB1 FOLD CHANGE")
...
ggsurvplot ( sfit,
             ...
             legend.labs = c("High diiference   ", "Low Difference   "),     # change legend labels.
             palette = c("#E7B800", "#2E9FDF"),
             title = "(TRIPLE NEGATIVE) - (PRKAA1,PRKAB1,PRKAB2,MTOR) vs RB1 FOLD CHANGE")              # Main Title
             #title = "(LUMINAL) - (PRKAA1,PRKAB1,PRKAB2,MTOR,STK11) vs RB1 FOLD CHANGE")              # Main Title
...
ggsurvplot ( sfit,
             ...
             palette = c("#E7B800", "#2E9FDF"),
             #title = "(TRIPLE NEGATIVE) - (PRKAA1,PRKAB1,PRKAB2,MTOR) vs RB1 FOLD CHANGE")              # Main Title
             title = "(LUMINAL) - (PRKAA1,PRKAB1,PRKAB2,MTOR) vs RB1 FOLD CHANGE")              # Main Title
